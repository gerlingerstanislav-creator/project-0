...
6. **Новости** — агрегатор RSS-лент из нескольких источников с категориями, эвристической оценкой значимости и персональной релевантности. По умолчанию сильнее учитываются IT, AI, стартапы, программирование, бизнес и управление. Новости одного события с похожими заголовками объединяются.
...
Лента разделяет **значимость** и **релевантность**: значимость оценивается по признакам изменения рынка, продукта, регулирования, безопасности и другим сигналам, а релевантность — по профилю интересов. Пользователь может выбрать категории и минимальный порог значимости. Политические новости не ранжируются по политическим предпочтениям; учитываются тема и общественная значимость.
