...
2. **Степан, выпей** — интерактивная мини-игра: бутылку нужно открыть, пиво переливается в стакан порциями, стакан можно выпивать, а после опустошения бутылки можно взять новую.
