...
2. **Степан, выпей** — интерактивная мини-игра: бутылку нужно открыть, при наливании она наклоняется к стакану, пиво переливается порциями, стакан выпивается целиком одним кликом, а после опустошения бутылки можно взять новую.
