            ...
            @forelse ($ideas as $idea)
                ...
                >
                    <summary class="startup-idea__title">
                        <span class="startup-idea__title-text" @if (auth()->user()->canEditIdeas()) data-editable="title" @endif>{{ $idea->title }}</span>
                    ...
                    <div class="startup-idea__description">
                        <p class="startup-idea__description-text" @if (auth()->user()->canEditIdeas()) data-editable="description" @endif>{{ $idea->description }}</p>
                    </div>
